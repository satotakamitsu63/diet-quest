...
const CASES: Case[] = [
  ...
  { utterance: '夜は焼き鳥とビールを飲んだ', expect: ['焼き鳥', 'ビール'] },
  { utterance: 'お好み焼きとたこ焼き食べた', expect: ['お好み焼き', 'たこ焼き'] },
  { utterance: 'ランチは天丼', expect: ['天丼'] },
  { utterance: 'カレーパンとホットドッグ買った', expect: ['カレーパン', 'ホットドッグ'] },
  { utterance: '水を飲んだ', expect: ['水'] },
  { utterance: 'ランチはスープカレー', expect: ['スープカレー'] },
  { utterance: '夜は焼き肉を食べた', expect: ['焼き肉'] },
  { utterance: 'きつねうどんとカツカレー', expect: ['きつねうどん', 'カツカレー'] },
  { utterance: '冷やし中華とレバニラ炒め', expect: ['冷やし中華', 'レバニラ'] },
