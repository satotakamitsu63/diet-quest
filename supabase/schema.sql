...
create table if not exists public.profiles (
  ...
  species text not null default 'dog' check (species in ('dog', 'cat', 'bear', 'bird', 'penguin')),
...
update public.profiles set species = 'bird' where species in ('dragon', 'chick', 'sparrow');
...
alter table public.profiles add constraint profiles_species_check
  check (species in ('dog', 'cat', 'bear', 'bird', 'penguin'));
